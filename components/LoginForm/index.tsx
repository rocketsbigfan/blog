...
export default function LoginForm({ user }: { user?: Omit<User, 'id'> }) {
  ...
  return user ? (
    <div className="ml-4 inline-flex items-center cursor-pointer" title="Logout" onClick={handleLogout}>
      {
        user.image ? (
          <Image
    ...
    <button className="dark:text-white hover:text-gray-500 ml-4" onClick={handleLogin}>
